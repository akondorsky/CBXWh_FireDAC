...
begin
  Action:=caFree;
  AnimateWindow(SlideWind_F.Handle, 500, AW_HIDE OR AW_VER_POSITIVE );  // ну и анимация окна....
  SlideWind_F:=nil;
end;
...
AnimateWindow((Sender as TForm).Handle, 500, AW_VER_NEGATIVE );  // ну и анимация окна....
Timer1.Enabled:=True;
end;
