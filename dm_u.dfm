object DM: TDM
  ...
  object DB: TIBDatabase
    Connected = True
    DatabaseName = 'localhost:c:\fb_db\SIRIUS_25.FDB'
    Params.Strings = (
      'user_name=sysdba'
      'password=mkey'
      'lc_ctype=UTF8')
  ...
  object _Qry_Parts: TIBQuery
    ...
    Left = 137
    Top = 80
    object _Qry_PartsID: TIntegerField
      FieldName = 'ID'
      Origin = '"TICKET_PARTS"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object _Qry_PartsID_TICKET: TIntegerField
      FieldName = 'ID_TICKET'
      Origin = '"TICKET_PARTS"."ID_TICKET"'
      Required = True
    end
    object _Qry_PartsID_OWNER: TIntegerField
      FieldName = 'ID_OWNER'
      Origin = '"TICKET_PARTS"."ID_OWNER"'
      Required = True
    end
    object _Qry_PartsNPP: TIntegerField
      FieldName = 'NPP'
      Origin = '"TICKET_PARTS"."NPP"'
      Required = True
    end
    object _Qry_PartsSTEP_CTRL: TIntegerField
      FieldName = 'STEP_CTRL'
      Origin = '"TICKET_PARTS"."STEP_CTRL"'
    end
    object _Qry_PartsPART_NOMER: TIBStringField
      FieldName = 'PART_NOMER'
      ProviderFlags = []
      Size = 23
    end
    object _Qry_PartsZAYV: TIBStringField
      DisplayWidth = 50
      FieldName = 'ZAYV'
      Origin = '"REG_TI"."ZAYV"'
      Size = 100
    end
    object _Qry_PartsSTEP_HUMAN: TStringField
      FieldKind = fkCalculated
      FieldName = 'STEP_HUMAN'
      Size = 35
      Calculated = True
    end
    object _Qry_PartsPAY_CONTROL: TIntegerField
      FieldName = 'PAY_CONTROL'
      Origin = '"TICKET_PARTS"."PAY_CONTROL"'
    end
    object _Qry_PartsID_PRICE: TIntegerField
      FieldName = 'ID_PRICE'
      Origin = '"REG_TI"."ID_PRICE"'
    end
    object _Qry_PartsTS_FLAG: TSmallintField
      FieldName = 'TS_FLAG'
      Origin = '"TICKET_PARTS"."TS_FLAG"'
    end
  end
  object _Qry_Usl: TIBQuery
    Database = DB
    Transaction = IBTR
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object _Qry_PriceList: TIBQuery
    Database = DB
    Transaction = IBTR
    BufferChunks = 1000
    CachedUpdates = False
